...
void convolute(Image* srcImage,Image* destImage,Matrix algorithm){
    ...
    # pragma omp parallel for num_threads(srcImage->height) \
        default(none) private(row, pix, bit) shared(destImage, srcImage, algorithm)
...
int main(int argc,char** argv){
    ...
    destImage.data=malloc(sizeof(uint8_t)*destImage.width*destImage.bpp*destImage.height); // why use malloc?
